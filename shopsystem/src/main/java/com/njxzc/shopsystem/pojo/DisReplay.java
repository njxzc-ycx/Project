...
public class DisReplay {
    ...
    public DisReplay(Integer replayId, String replayDes, Integer replayerId, Integer msgId, Integer msgerId, Timestamp replayTime, User user) {
