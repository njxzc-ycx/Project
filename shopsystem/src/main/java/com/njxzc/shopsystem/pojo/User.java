...
public class User {
    ...
    public String getMsgerName() {
        return msgerName;
    }

    public void setMsgerName(String msgerName) {
        this.msgerName = msgerName;
    }
    ...
    private List<Collect> collectList;//一个用户有多个收藏
