...
public class CollectsAdapter extends BaseAdapter {
    ...
    public CollectsAdapter(Context context, List<Map<String,Object>> data){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        //通过样式文件创建view
        View view = layoutInflater.inflate(R.layout.collects_style,null);
