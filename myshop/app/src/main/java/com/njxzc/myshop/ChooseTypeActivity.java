...
import com.njxzc.myshop.adapter.ChooseTypeSecondAdapter;
...
public class ChooseTypeActivity extends AppCompatActivity {
    ...
    private ChooseTypeSecondAdapter chooseTypeSecondAdapter;
                ...
                OkhttpHelper.getAllTypefirst(url, new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ChooseTypeActivity.this, "网络连接失败", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    typeFirstAdapter = new TypeFirstAdapter(ChooseTypeActivity.this,typeFirstDatas);
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        try {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    chooseTypeSecondAdapter=new ChooseTypeSecondAdapter(ChooseTypeActivity.this,typeSecondDatas);
                                    lv_typeSecond.setAdapter(chooseTypeSecondAdapter);
