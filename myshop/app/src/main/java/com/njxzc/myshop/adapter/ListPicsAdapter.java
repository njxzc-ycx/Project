...
public class ListPicsAdapter extends BaseAdapter {
    ...
    public ListPicsAdapter(Context context, ArrayList data){
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (position < data.size()) {
            ...
            pics.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    PhotoPicker.builder()
                            .setPhotoCount(PublishDisActivity.count)
                            .setShowCamera(true)
                            .setShowGif(true)
