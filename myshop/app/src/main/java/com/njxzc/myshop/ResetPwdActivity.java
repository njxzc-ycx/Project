...
import com.njxzc.myshop.personal_activity.UpdatePwdActivity;
            ...
            if (msg.what == -9) {
                ...
                if (result == SMSSDK.RESULT_COMPLETE) {
                    ...
                    if (event == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE) {// 提交验证码成功
                        ...
                        mProgressDialog = ProgressDialog.show(ResetPwdActivity.this, "", "正在提交...");
                        Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String url = OkhttpHelper.getIp()+"/shopsystem/androidUser/resetUserPwd";
                                            ...
                                            public void run() {
                                                switch (responseData) {
                                                    case "resetPwdSuccess":
                                                        String url = "http://a1.easemob.com/1178210225148941/myshop/users/"+phone+"/password";
                                                        OkhttpHelper.updateIMPWD(url, password, new okhttp3.Callback() {
                                                            @Override
                                                            public void onFailure(Call call, IOException e) {
