...
public class UpdatePhoneActivity extends AppCompatActivity {
    ...
    public void submit(View v) throws Exception{
        ...
        if(!judgePhoneNums(phone)) {
            ...
            mProgressDialog = ProgressDialog.show(UpdatePhoneActivity.this, "", "正在提交...");
            Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    String url = OkhttpHelper.getIp()+"/shopsystem/androidUser/updateUserPhone";
